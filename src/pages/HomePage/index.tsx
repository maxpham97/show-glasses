...
import { useGetBasketState } from '../../redux/basket/basketSlice';

const HomePage = () => {
    const { t } = useTranslation();
    const stateBasket = useGetBasketState();

    const summBasket = stateBasket.basketProducts.reduce((total, product) => total + product.price * (product.quantity ?? 1), 0);
    console.log('summBasket', summBasket);
